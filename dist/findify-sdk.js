...
/***/ function(module, exports, __webpack_require__) {
	...
	var omit = __webpack_require__(135);
	var requestApi_1 = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./modules/requestApi\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	var requestResults_1 = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./modules/requestResults\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	function init(config) {
	    ...
	    return {
	        ...
	        search: function search(request) {
	            ...
	            return requestResults_1.requestResults('/search', request, config);
	        },
	        collection: function collection(request) {
	            ...
	            return requestResults_1.requestResults("/collection/" + request.slot, omittedRequest, config);
	        },
	        recommendations: function recommendations(type, request) {
	            ...
	            if (type === 'latest') {
	                return requestApi_1.requestApi('/recommend/items/latest', request, config);
	            }
	        },
	        feedback: function feedback(request) {
	            if (!request || typeof request.event === 'undefined') {
	                throw new Error('"event" param is required');
	            }
	            return requestApi_1.requestApi('/feedback', request, config);
	        }
	    };
	}
	exports.init = init;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stack = __webpack_require__(49),
	    ...
	    baseAssignIn = __webpack_require__(57),
	    ...
	    getAllKeysIn = __webpack_require__(32),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addMapEntry = __webpack_require__(52),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addSetEntry = __webpack_require__(53),
	    arrayReduce = __webpack_require__(26),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flatten = __webpack_require__(130),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(25),
	    ...
	    baseUnset = __webpack_require__(72),
